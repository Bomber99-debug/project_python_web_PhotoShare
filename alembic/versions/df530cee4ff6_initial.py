...
Revision ID: df530cee4ff6
Revises: 
Create Date: 2026-08-22 21:40:19.153596
"""
...
def upgrade() -> None:
	...
	op.create_table( 'photo_transforms',
	                 ...
	                 sa.ForeignKeyConstraint( [ 'photo_id' ], [ 'photos.id' ], ondelete='CASCADE' ),
	                 sa.PrimaryKeyConstraint( 'id' ), )
	op.create_index( op.f( 'ix_photo_transforms_photo_id' ), 'photo_transforms', [ 'photo_id' ], unique=False )
	...
	op.create_index( op.f( 'ix_ratings_user_id' ),
	                 'ratings',
	                 [ 'user_id' ],
...
def downgrade() -> None:
	...
	op.drop_index( op.f( 'ix_photo_transforms_photo_id' ), table_name='photo_transforms' )
