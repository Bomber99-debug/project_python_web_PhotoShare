...
async def test_upload_rejects_more_than_five_tags(
    client,
    user_headers,
):
    files = [
...
async def test_upload_rejects_empty_tag(
    client,
    user_headers,
):
    files = [
...
async def test_upload_cleans_cloudinary_if_database_operation_fails(
    client,
    user_headers,
    mock_cloudinary,
    monkeypatch,
    ...
    monkeypatch.setattr(
        "src.routes.photos.create_photo",
        broken_create_photo,
    )
    ...
    assert mock_cloudinary["uploaded"] == [
        "photoshare/test-1",
    ]

    assert mock_cloudinary["deleted"] == [
        "photoshare/test-1",
    ]
...
async def test_update_photo_description_and_tags(
    client,
    user_headers,
    create_photo,
):
...
async def test_other_user_cannot_update_or_delete_photo(
    client,
    user_headers,
    other_user_headers,
    create_photo,
...
async def test_admin_can_update_and_delete_other_users_photo(
    client,
    user_headers,
    admin_headers,
    create_photo,
...
async def test_photo_not_found(
    client,
    user_headers,
):
...
async def test_create_and_list_comments(
    ...
    create = await client.post(
        f"/api/photos/{photo['id']}/comments",
        headers=user_headers,
        json={
            "text": "  Nice photo!  ",
        },
...
async def test_user_can_edit_own_comment(
    client,
    user_headers,
    create_photo,
):
...
async def test_other_user_cannot_edit_comment(
    client,
    user_headers,
    other_user_headers,
    create_photo,
...
async def test_normal_user_cannot_delete_comment(
    client,
    user_headers,
    create_photo,
):
...
async def test_comment_not_found_cases(
    client,
    user_headers,
    admin_headers,
):
