...
async def search_photos(
    keyword: str | None = None, tag: str | None = None, min_rating: float | None = Query(default=None, ge=1, le=5),
    ...
    return await repository_search(
        db, keyword=keyword, tag=normalized_tag, min_rating=min_rating, sort_by=sort_by, order=order,
